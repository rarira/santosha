function IntroSpeechBubble() {
  ...
  return (
    <div className="absolute flex flex-row bottom-20 left-[calc(50%-50px)] ">
      <div
        className={`absolute left-[-0.85rem] bottom-[2rem] w-0 h-0 border-blue-500 border-y-transparent  border-y-[0.75rem]  border-r-[1rem]`}
      />
      ...
      <div className="flex flex-col w-full max-w-[320px] leading-1.5 p-4 bg-blue-500 rounded-xl shadow-lg shadow-blue-200">
        <div className="flex items-center space-x-2 rtl:space-x-reverse">
          <span className="text-xl font-bold text-lime-200">Lizzy</span>
